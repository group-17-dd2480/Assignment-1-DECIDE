...
## Usage Instructions
### Requirements
- Java 21 (can work with older versions, but not guaranteed)
- Make (recommended, but optional)

### Running the Program
This project uses [JUnit v.1.11.4](https://mvnrepository.com/artifact/org.junit.platform/junit-platform-console-standalone/1.11.4) for testing.
